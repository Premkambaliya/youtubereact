...
<div className="side">
    ...
    <img className="home" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/explore.png?raw=true" alt=""/>
    <p className="sidebar">Explores</p>
    
    <img src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/02.youtube-clone/assets/shorts.png?raw=true" alt=""/>
    <p className="sidebar">Shorts</p>
...
<hr className='hr' />
    ...
    <p className="sidebar">Nadir On The Go</p>
    ...
    <p className="sidebar">Coke Shudio Bangla</p>
    ...
    <p className="sidebar">Android ToTo C...</p>
    ...
    <p className="sidebar">Alux.com</p>    
</div>
